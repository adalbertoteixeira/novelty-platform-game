...
const CloudPlatform = function CloudPlatformCb(gameObj, x, y, key, group) {
...
const PhaserGame = function PhaserGameCb() {
  this.bg = null;
  this.trees = null;
  this.player = null;
  this.gifts = null;
...
PhaserGame.prototype = {
  ...
  create() {
    ...
    const cloud1 = new CloudPlatform(this.game, 300, 450, 'cloud-platform', this.clouds);
    ...
    const cloud2 = new CloudPlatform(this.game, 800, 96, 'cloud-platform', this.clouds);
    ...
    const cloud3 = new CloudPlatform(this.game, 1300, 290, 'cloud-platform', this.clouds);
    ...
    this.giftsCount.forEach((position) => {
      const star = this.gifts.create(position, 0, 'star');
  ...
  update() {
    ...
    const standing = this.player.body.blocked.down || this.player.body.touching.down || this.locked;
...
window.onload = function onLoadCb() {
  ...
  const playersWrapper = document.getElementById('players');
